export function normaliseDomainScores(data) {
  return [
    { domain: 'Sustained Attention',  score: normaliseTask1(data?.task1), fullMark: 100 },
    { domain: 'Inhibition Control',   score: normaliseTask2(data?.task2), fullMark: 100 },
    { domain: 'Interference Control', score: normaliseTask3(data?.task3), fullMark: 100 },
    { domain: 'Working Memory',       score: normaliseTask4(data?.task4), fullMark: 100 },
  ]
}
